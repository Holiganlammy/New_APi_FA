...
const OPS_Mobile_List_Vender = async (req, res, next) => {
  try {
    ...
    const list_Vender = await query_OPS_mobile.OPS_Mobile_List_Vender(
      assetCode
    );
...
const STrack_Registation = async (req, res, next) => {
  ...
  try {
    ...
    if (response[0].userReply) {
      ...
      axios.post("https://api.line.me/v2/bot/message/push", sendJSON, {
        headers,
      });
    }
  } catch (error) {
  ...
  try {
    ...
    if (events.length > 0) {
      if (events[0].source.userId) {
        const venderID = await query_OPS_mobile.STrack_CheckVenderID(
...
const handleEvent = async (event) => {
  if (event.type === "postback") {
    ...
    const body = {
      ...
      userid_line: event.source.userId,
    };
    ...
    if ((venderID ? venderID.length : 0) > 0) {
      ...
      if (!(venderID ? venderID[0].response : undefined)) {
        ...
        (venderID ? venderID[0].response : undefined).indexOf("cancel STK") > -1
      ) {
        ...
        (venderID ? venderID[0].response : undefined) === "แสดงงาน OPS"
      ) {
        const formattedTimeStep1 = item.time_step1
          ? dayjs(item.time_step1).format("DD/MM/YYYY HH:mm")
          : "";
        const formattedTimeStep2 = item.time_step2
          ? dayjs(item.time_step2).format("DD/MM/YYYY HH:mm")
          : "";
        const formattedTimeStep3 = item.time_step3
          ? dayjs(item.time_step3).format("DD/MM/YYYY HH:mm")
          : "";
        const formattedTimeStep4 = item.time_step4
          ? dayjs(item.time_step4).format("DD/MM/YYYY HH:mm")
          : "";
              ...
              contents: [
                    ...
                    },
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          height: "12px",
                          width: "12px",
                          borderColor: formattedTimeStep1 ? "#1DB446" : "#EF454D",
                          borderWidth: "2px",
                          backgroundColor: formattedTimeStep1
                            ? "#1DB446"
                            : "#EF454D",
                        },
                        {
                      ...
                      contents: [
                        {
                          ...
                          contents: [
                            ...
                            },
                            {
                              ...
                              contents: [],
                              width: "2px",
                              backgroundColor: formattedTimeStep2
                                ? "#1DB446"
                                : "#EF454D",
                            },
                            {
                  ...
                  contents: [
                    {
                      ...
                      contents: [
                        {
                          type: "text",
                          text: `${formattedTimeStep2 ? formattedTimeStep2 : null}`,
                          gravity: "center",
                          size: "xs",
                          align: "center",
                        },
                    ...
                    },
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          height: "12px",
                          borderWidth: "2px",
                          borderColor: formattedTimeStep2 ? "#1DB446" : "#EF454D",
                          backgroundColor: formattedTimeStep2
                            ? "#1DB446"
                            : "#EF454D",
                        },
                      ...
                      contents: [
                        {
                          ...
                          contents: [
                            ...
                            },
                            {
                              ...
                              contents: [],
                              width: "2px",
                              backgroundColor: formattedTimeStep3
                                ? "#1DB446"
                                : "#EF454D",
                            },
                            {
                  ...
                  contents: [
                    {
                      ...
                      contents: [
                        {
                          type: "text",
                          text: `${formattedTimeStep3 ? formattedTimeStep3 : null}`,
                          gravity: "center",
                          size: "xs",
                          align: "center",
                        },
                    ...
                    },
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          height: "12px",
                          borderWidth: "2px",
                          borderColor: formattedTimeStep3 ? "#1DB446" : "#EF454D",
                          backgroundColor: formattedTimeStep3
                            ? "#1DB446"
                            : "#EF454D",
                        },
                      ...
                      contents: [
                        {
                          ...
                          contents: [
                            ...
                            },
                            {
                              ...
                              contents: [],
                              width: "2px",
                              backgroundColor: formattedTimeStep4
                                ? "#FFA500"
                                : "#EF454D",
                            },
                            {
                ...
                },
                {
                  ...
                  contents: [
                    {
                      type: "text",
                      text: `${formattedTimeStep3 ? formattedTimeStep4 : null}`,
                      gravity: "center",
                      size: "xs",
                      align: "center",
                    },
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          width: "12px",
                          height: "12px",
                          borderColor: formattedTimeStep4 ? "#FFA500" : "#EF454D",
                          borderWidth: "2px",
                          backgroundColor: formattedTimeStep4
                            ? "#FFA500"
                            : "#EF454D",
              ...
              contents: [
                {
                  ...
                  action: {
                    ...
                    text: item.userid_line
                      ? `${item.STK_CODE}`
                      : `${item.statusid + 1}>${item.STK_CODE}`,
                  },
                  height: "sm",
                  style: "primary",
        ...
        (venderID ? venderID[0].response : undefined) === "แสดงงาน OPS ของฉัน"
      ) {
              ...
              contents: [
                ...
                },
                {
                  ...
                  contents: [
                    {
                      type: "text",
                      text: `${formattedTimeStep1 ? formattedTimeStep1 : null}`,
                      size: "xs",
                      gravity: "center",
                      align: "center",
                    },
            ...
            footer: {
              ...
              contents: [
                ...
                },
                {
                  ...
                  style: "primary",
                  color: formattedTimeStep4 ? "#AAAAAA" : "#1DB446",
                  margin: "sm",
                },
                {
                  type: "button",
                  ...
                  contents: [
                    {
                      type: "text",
                      text: `${
                        venderID[0].time_step1 ? venderID[0].time_step1 : null
                      }`,
                      size: "xs",
                      gravity: "center",
                      align: "center",
                    },
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          height: "12px",
                          width: "12px",
                          borderColor: venderID[0].time_step1
                            ? "#1DB446"
                            : "#EF454D",
                          borderWidth: "2px",
                          backgroundColor: venderID[0].time_step1
                            ? "#1DB446"
                            : "#EF454D",
                        },
                        {
                      ...
                      contents: [
                        {
                          ...
                          contents: [
                            ...
                            },
                            {
                              ...
                              contents: [],
                              width: "2px",
                              backgroundColor: venderID[0].time_step2
                                ? "#1DB446"
                                : "#EF454D",
                            },
                            {
                    ...
                    },
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          height: "12px",
                          borderWidth: "2px",
                          borderColor: venderID[0].time_step2
                            ? "#1DB446"
                            : "#EF454D",
                          backgroundColor: venderID[0].time_step2
                            ? "#1DB446"
                      ...
                      contents: [
                        {
                          ...
                          contents: [
                            ...
                            },
                            {
                              ...
                              contents: [],
                              width: "2px",
                              backgroundColor: venderID[0].time_step3
                                ? "#1DB446"
                                : "#EF454D",
                            },
                            {
                    ...
                    },
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          height: "12px",
                          borderWidth: "2px",
                          borderColor: venderID[0].time_step3
                            ? "#1DB446"
                            : "#EF454D",
                          backgroundColor: venderID[0].time_step3
                            ? "#1DB446"
                      ...
                      contents: [
                        {
                          ...
                          contents: [
                            ...
                            },
                            {
                              ...
                              contents: [],
                              width: "2px",
                              backgroundColor: venderID[0].time_step4
                                ? "#FFA500"
                                : "#EF454D",
                            },
                            {
                  ...
                  contents: [
                    {
                      type: "text",
                      text: `${
                        venderID[0].time_step4 ? venderID[0].time_step4 : null
                      }`,
                      gravity: "center",
                      size: "xs",
                      align: "center",
                    },
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          width: "12px",
                          height: "12px",
                          borderColor: venderID[0].time_step4
                            ? "#FFA500"
                            : "#EF454D",
                          borderWidth: "2px",
                          backgroundColor: venderID[0].time_step4
...
const STrack_responseFlex_AfterInsert = async (req, res, next) => {
  try {
    const body = req.body;
    const response = await query_OPS_mobile.STrack_responseFlex_AfterInsert(
      body
    );
    res.setHeader("Content-Type", "application/json; charset=utf-8");
              ...
              contents: [
                {
                  type: "text",
                  text: `${
                    response[0].time_step1 ? response[0].time_step1 : null
                  }`,
                  size: "xs",
                  gravity: "center",
                  align: "center",
                },
                {
                  ...
                  contents: [
                    ...
                    },
                    {
                      ...
                      height: "12px",
                      width: "12px",
                      borderColor: response[0].time_step1
                        ? "#1DB446"
                        : "#EF454D",
                      borderWidth: "2px",
                      backgroundColor: response[0].time_step1
                        ? "#1DB446"
                        : "#EF454D",
                    },
                    {
                  ...
                  contents: [
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          contents: [],
                          width: "2px",
                          backgroundColor: response[0].time_step2
                            ? "#1DB446"
                            : "#EF454D",
                        },
                        {
                  ...
                  contents: [
                    {
                      type: "text",
                      text: `${
                        response[0].time_step2 ? response[0].time_step2 : null
                      }`,
                      gravity: "center",
                      size: "xs",
                      align: "center",
                ...
                },
                {
                  ...
                  contents: [
                    ...
                    },
                    {
                      ...
                      height: "12px",
                      borderWidth: "2px",
                      borderColor: response[0].time_step2
                        ? "#1DB446"
                        : "#EF454D",
                      backgroundColor: response[0].time_step2
                        ? "#1DB446"
                  ...
                  contents: [
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          contents: [],
                          width: "2px",
                          backgroundColor: response[0].time_step3
                            ? "#1DB446"
                            : "#EF454D",
                        },
                        {
                  ...
                  contents: [
                    {
                      type: "text",
                      text: `${
                        response[0].time_step3 ? response[0].time_step3 : null
                      }`,
                      gravity: "center",
                      size: "xs",
                      align: "center",
                ...
                },
                {
                  ...
                  contents: [
                    ...
                    },
                    {
                      ...
                      height: "12px",
                      borderWidth: "2px",
                      borderColor: response[0].time_step3
                        ? "#1DB446"
                        : "#EF454D",
                      backgroundColor: response[0].time_step3
                        ? "#1DB446"
                  ...
                  contents: [
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          contents: [],
                          width: "2px",
                          backgroundColor: response[0].time_step4
                            ? "#FFA500"
                            : "#EF454D",
                        },
                        {
              ...
              contents: [
                {
                  type: "text",
                  text: `${
                    response[0].time_step3 ? response[0].time_step4 : null
                  }`,
                  gravity: "center",
                  size: "xs",
                  align: "center",
                },
                {
                  ...
                  contents: [
                    ...
                    },
                    {
                      ...
                      width: "12px",
                      height: "12px",
                      borderColor: response[0].time_step4
                        ? "#FFA500"
                        : "#EF454D",
                      borderWidth: "2px",
                      backgroundColor: response[0].time_step4
      ...
      if (response.every(hasUserid)) {
        for (var i = 0; i < response.length; i++) {
          if (response[i].userid) {
            ...
            client.getProfile(response[i].userid).then(async (profile) => {
              const sendJSON = {
                to: profile.userId,
                messages: [
                  {
...
const STrack_End_Comments = async (req, res) => {
  try {
    ...
    if (new_data.length == 0) {
              ...
              contents: [
                {
                  type: "text",
                  text: `${
                    new_data[0].time_step1 ? new_data[0].time_step1 : null
                  }`,
                  size: "xs",
                  gravity: "center",
                  align: "center",
                },
                {
                  ...
                  contents: [
                    ...
                    },
                    {
                      ...
                      height: "12px",
                      width: "12px",
                      borderColor: new_data[0].time_step1
                        ? "#1DB446"
                        : "#EF454D",
                      borderWidth: "2px",
                      backgroundColor: new_data[0].time_step1
                        ? "#1DB446"
                        : "#EF454D",
                    },
                    {
                  ...
                  contents: [
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          contents: [],
                          width: "2px",
                          backgroundColor: new_data[0].time_step2
                            ? "#1DB446"
                            : "#EF454D",
                        },
                        {
                  ...
                  contents: [
                    {
                      type: "text",
                      text: `${
                        new_data[0].time_step2 ? new_data[0].time_step2 : null
                      }`,
                      gravity: "center",
                      size: "xs",
                      align: "center",
                ...
                },
                {
                  ...
                  contents: [
                    ...
                    },
                    {
                      ...
                      height: "12px",
                      borderWidth: "2px",
                      borderColor: new_data[0].time_step2
                        ? "#1DB446"
                        : "#EF454D",
                      backgroundColor: new_data[0].time_step2
                        ? "#1DB446"
                  ...
                  contents: [
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          contents: [],
                          width: "2px",
                          backgroundColor: new_data[0].time_step3
                            ? "#1DB446"
                            : "#EF454D",
                        },
                        {
                  ...
                  contents: [
                    {
                      type: "text",
                      text: `${
                        new_data[0].time_step3 ? new_data[0].time_step3 : null
                      }`,
                      gravity: "center",
                      size: "xs",
                      align: "center",
                ...
                },
                {
                  ...
                  contents: [
                    ...
                    },
                    {
                      ...
                      height: "12px",
                      borderWidth: "2px",
                      borderColor: new_data[0].time_step3
                        ? "#1DB446"
                        : "#EF454D",
                      backgroundColor: new_data[0].time_step3
                        ? "#1DB446"
                  ...
                  contents: [
                    {
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          contents: [],
                          width: "2px",
                          backgroundColor: new_data[0].time_step4
                            ? "#FFA500"
                            : "#EF454D",
                        },
                        {
              ...
              contents: [
                {
                  type: "text",
                  text: `${
                    new_data[0].time_step3 ? new_data[0].time_step4 : null
                  }`,
                  gravity: "center",
                  size: "xs",
                  align: "center",
                },
                {
                  ...
                  contents: [
                    ...
                    },
                    {
                      ...
                      width: "12px",
                      height: "12px",
                      borderColor: new_data[0].time_step4
                        ? "#FFA500"
                        : "#EF454D",
                      borderWidth: "2px",
                      backgroundColor: new_data[0].time_step4
      ...
      client.getProfile(new_data[0].userid_line).then(async (profile) => {
        const sendJSON = {
          to: profile.userId,
          messages: [
            {
...
const STcheck_files = async (req, res) => {
  ...
  file.mv(
    `${newpath}${new_path[0].ATT}.${filename.split(".").pop()}`,
    async (err) => {
      if (err) {
      ...
      const body = {
        st_code: st_code,
        url: `${url}${new_path[0].ATT}.${filename.split(".").pop()}`,
        user: usercode,
        description: st_code,
      };
...
const STK_unCompletedBy_User = async (req, res) => {
  try {
    ...
    if (new_data.length == 0) {
      ...
      res
        .status(200)
        .send(JSON.stringify({ message: "success", data: new_data }));
      const headers = {
        Authorization: `Bearer ${env.ACCESSTOKEN}`,
        "Content-Type": "application/json; charset=utf-8",
      };
